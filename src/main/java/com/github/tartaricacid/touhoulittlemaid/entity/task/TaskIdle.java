...
public class TaskIdle implements IMaidTask {
    ...
    public List<Pair<Integer, Behavior<? super EntityMaid>>> createBrainTasks(EntityMaid maid) {
        Pair<Integer, Behavior<? super EntityMaid>> findSnowballTarget = Pair.of(6, new MaidStartSnowballAttacking<>(this::canSnowballFight, this::findFirstValidSnowballTarget));
        Pair<Integer, Behavior<? super EntityMaid>> snowballFight = Pair.of(7, new MaidSnowballTargetTask(40));
